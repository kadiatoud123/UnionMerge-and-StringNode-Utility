 ...
 * approach allouniows us to use recursion to write many of the methods,
...
public class StringNode {
    ...
    public static StringNode copy(StringNode str) {
        ...
        StringNode trav= str;
        StringNode copy= new StringNode(trav.ch, null);
        StringNode copyC= copy;
        while(trav.next!=null){
            trav= trav.next;
            copyC.next= new StringNode(trav.ch, null);
            copyC= copyC.next;
                                         ...
                                         char afterChar) 
    {
        ...
        if (trav.ch == afterChar) {
            ...
            newNode= new StringNode(newChar, trav.next);
            trav.next = newNode;
            return str;
            
        } 
            trav.next= insertAfter(trav.next, newChar, afterChar);
